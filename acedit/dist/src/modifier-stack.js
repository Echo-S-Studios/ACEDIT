 ...
 */
export function applyModifierStack(base, modifiers) {
    // Validate base
 ...
 */
export function extractModifiers(input) {
    const modifiers = [];
    let base = null;
 ...
 */
export function normalizeModifierOrder(modifiers) {
 ...
 */
export function validateModifierCombination(modifiers) {
 ...
 */
export function getMaxStackDepth() {
 ...
 */
export function isStackDepthExceeded(modifiers) {
    return modifiers.length > getMaxStackDepth();
}
//# sourceMappingURL=modifier-stack.js.map