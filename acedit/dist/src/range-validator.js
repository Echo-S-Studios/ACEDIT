 ...
 */
import { UNICODE_RANGES, getRegisterForCodepoint } from './constants-registry.js';
/**
 * Validates a single codepoint
 * Enforces: Register Sovereignty invariant
 */
export function validateCodepoint(codepoint) {
 ...
 */
export function isInRegister(codepoint, register) {
 ...
 */
export function getStringRegisters(input) {
 ...
 */
export function validateNoRegisterOverlap() {
