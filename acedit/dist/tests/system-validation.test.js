...
import { initializeACEDIT, ACEDIT_CONSTANTS, validateConvergenceConstant, validateNoRegisterOverlap, UNICODE_RANGES, getRegisterForCodepoint, getAllRegisterStats } from '../src/index.js';
...
test('Invariant 3: Convergence Constant - √3/2', () => {
    ...
    assert.ok(Math.abs(ACEDIT_CONSTANTS.Z_C - expected) < ACEDIT_CONSTANTS.EPSILON, 'Z_C should equal √3/2');
    assert.equal(ACEDIT_CONSTANTS.Z_C_SYMBOLIC, '√3/2', 'Symbolic representation should be √3/2');
});
...
//# sourceMappingURL=system-validation.test.js.map